...
QMAKE_POST_LINK += && "C:\\Qt\\5.15.2\\msvc2019_64\\bin\\windeployqt.exe" --translations en,de,ru,ja,fr --no-compiler-runtime --no-system-d3d-compiler --no-opengl-sw \"$$OUT_PWD\\dist\\$${TARGET}.exe\"
